  ...
  return (
    <>
      <section className="container mx-auto p-4">
        <div className="grid grid-cols-[repeat(auto-fill,minmax(12rem,1fr))] gap-x-8 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {posts2.map((post) => (
            <div
              key={post.title}
              className="group relative before:absolute before:-inset-2.5 before:rounded-[20px] before:bg-zinc-900 before:opacity-100 hover:before:opacity-100"
            >
              <div className="relative aspect-[3/2] overflow-hidden rounded-lg">
                <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                  <div className="flex-shrink-0">
                    <img className="h-auto w-full object-cover" src={post.imageUrl} alt="" />
                  </div>
                </div>
              </div>
              <h4 className="mt-4 font-bold text-md text-zinc-400 group-hover:text-orange-500">
                <a href="#">
                  <span className="absolute -inset-2.5 z-10"></span>
                  <span className="relative">What is a Virtual Assistant</span>
                </a>
              </h4>
              <a className="relative mt-1.5 font-light text-sm text-zinc-300 tracking-wider">
                Nemo vel ad consectetur namut rutrum ex, venenatis sollicitudin urna. Aliquam erat volutpat. Integer eu ipsum sem. Ut
                bibendum lacus vestibulum maximus suscipit. Quisque vitae nibh iaculis neque blan
              </a>
            </div>
          ))}
        </div>
          ...
          <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {posts.map((post) => (
              <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
                <div className="flex flex-col w-full mb-4 overflow-hidden rounded-lg shadow-lg">
